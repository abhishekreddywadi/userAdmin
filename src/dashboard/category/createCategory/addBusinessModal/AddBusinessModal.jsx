...
const AddBusinessModal = ({ showBusinessModal, handleBusinessModalHide, businessModalImageSrc, handleBusinessModalFileChange }) => {
  ...
  return (
    <Modal className='add-modal business-modal' show={showBusinessModal} onHide={handleBusinessModalHide}>
          ...
          <div className="row" style={{gap: '25px 0'}}>
            ...
            <div className="col-12 col-md-6">
              <div className="input-container img-container">
                <span className='uploaded-img' style={{padding: '10px'}}>{businessModalImageSrc && <img src={businessModalImageSrc} alt="Uploaded" />}</span>
                <div className='d-flex flex-column ml-auto' style={{width: 'calc(100% - 110px)'}}>
                  <label htmlFor="">Business Name</label>
                  <input type="text" placeholder='Enter Business Name' />
                </div>
                <input type="file" onChange={handleBusinessModalFileChange} />
              </div>
            </div>
            ...
            <div className="col-12 col-md-6">
              <div className="input-container">
                ...
                <textarea placeholder='Add Business Description'></textarea>
              </div>
            </div>
      ...
      <Modal.Footer>
        <Button variant="secondary" onClick={handleBusinessModalHide}>
          Cancel
        </Button>
        <Button variant="primary" onClick={handleBusinessModalHide}>
          Save
        </Button>
      </Modal.Footer>
