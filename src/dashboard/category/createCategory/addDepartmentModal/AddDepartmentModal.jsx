...
function AddDepartmentModal({showDepartmentModal, handleDepartmentModalHide, departmentModalImageSrc, handleDepartmentModalFileChange, business }) {
  const [addModalDepartmentImageSrc, setAddModalDepartmentImageSrc] = useState('');
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      ...
      reader.onload = (e) => setAddModalDepartmentImageSrc(e.target.result);
          ...
          <form action="">
            <div className="row" style={{gap: '25px 0'}}>
              <div className="col-12 p-0" style={{display: 'flex', gap: '5px'}} >
                ...
                <div className="col-6 col-md-6">
                <div className="input-container">
                  <label htmlFor="">Trademark Class</label>
                  <input type="text" />
                </div>
              </div>
            </div>
              ...
              <div className="col-12 col-md-6">
                <div className="input-container img-container">
                  <span className='uploaded-img' style={{padding: '10px'}}  >{departmentModalImageSrc && <img src={departmentModalImageSrc} alt="Uploaded" />}</span>
                  <div className='d-flex flex-column ml-auto' style={{width: 'calc(100% - 110px)'}}>
