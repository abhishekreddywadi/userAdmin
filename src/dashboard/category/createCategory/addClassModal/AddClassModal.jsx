...
const AddClassModal = ({ showAddClassModal, handleAddClassModalHide, addNameLabel, departmentLabel }) => {
    const [addModalClassImageSrc, setAddModalClassImageSrc] = useState('');
    ...
    const handleFileChange = (e) => {
        ...
        if (file) {
            ...
            reader.onload = (e) => setAddModalClassImageSrc(e.target.result);
    ...
    return (
        <Modal className='add-modal sub-cat-modal' show={showAddClassModal} onHide={handleAddClassModalHide} size="lg">
                    ...
                    <div className="row" style={{gap: '25px 0'}}>
                        <div className="col-12 col-md-6">
                            <div className="input-container img-container">
                                <span className='uploaded-img' style={{padding: '10px'}}>{addModalClassImageSrc && <img src={addModalClassImageSrc} alt="Uploaded" />}</span>
                        ...
                        <div className="col-12 col-md-6">
                            <div className="input-container">
                                ...
                                <select name="" id="">
                                    <option value="" disabled>Select Parent business</option>
                ...
                <div className="input-container check">
                  ...
                  <div className="row">
                    ...
                    <div className="col-4 d-flex align-items-center" style={{gap: 5}}>
                      ...
                      <label className='mb-0' htmlFor="mb">MU</label>
                    </div>
                  </div>
                </div>
              </div>
