...
const AddCourseCategory = ({ showCourseModal, handleCourseModalHide, courseModalImageSrc, handleCourseModalFileChange }) => {
    ...
    return (
        <Modal className='add-modal sub-cat-modal' show={showCourseModal} onHide={handleCourseModalHide}>
                    ...
                    <div className="row" style={{gap: '25px 0'}}>
                        <div className="col-12 col-md-6">
                            <div className="input-container img-container">
                                <span className='uploaded-img' style={{padding: '10px'}}>{courseModalImageSrc && <img src={courseModalImageSrc} alt="Uploaded" />}</span>
                                <div className='d-flex flex-column ml-auto' style={{width: 'calc(100% - 110px)'}}>
                                    <label htmlFor="">Course Category</label>
                                    <input type="text" placeholder='Add Course Category' />
                                </div>
                                <input type="file" onChange={handleCourseModalFileChange} />
                            </div>
                        </div>
            ...
            <Modal.Footer>
                <Button variant="secondary" onClick={handleCourseModalHide}>
                    Cancel
                </Button>
                <Button variant="primary" onClick={handleCourseModalHide}>
                    Save
                </Button>
            </Modal.Footer>
