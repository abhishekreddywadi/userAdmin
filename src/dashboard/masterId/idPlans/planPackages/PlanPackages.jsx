...
export const PlanPackages = () => {
  ...
  function GridView() {
    const plans = [
      { id: 1, title: 'Master ID', price: '1000', img: ConstructionImg, description: 'This is an input not demo tax.' },
      { id: 2, title: 'Physical PVC ID Card', price: '500', img: ConstructionImg, description: 'This is an input not demo tax.' },
      { id: 3, title: 'Business ID', price: '500', img: ConstructionImg, description: 'This is an input not demo tax.' },
    ];
      ...
      <table className="table plan-table">
        ...
        <tbody>
          {plans.map(plan => (
            <tr key={plan.id}>
              <td>{plan.title}</td>
              <td><img src={plan.img} alt='plan' /></td>
              <td>RS {plan.price}</td>
  ...
  return (
    <div className="plan-packages">
      <Tabs defaultActiveKey="plan" id="plan-packages-tabs">
        <Tab eventKey="plan" title="Plan">
          <div className="view-mode-switcher">
            <button onClick={() => setViewMode('grid')}>Grid 
            ...
            <button onClick={() => setViewMode('table')}>Table 
