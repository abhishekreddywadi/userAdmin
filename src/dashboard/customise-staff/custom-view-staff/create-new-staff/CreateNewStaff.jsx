      ...
      <div className="container">
        <Form onSubmit={handleSubmit} className="registration-form my-5">
            ...
            <Row className="justify-content-between">
              <Col md={6}>
                <div className="profile-info">
                  ...
                  <div className="profile-details">
                    <h6 className="d-flex align-items-center" style={{gap: 10}}>PANKAJ SHING {formData.idStatus === "User Id" && <p className="mb-0" style={{color: 'red', fontSize:10}}>Don't have Master ID</p>}</h6>
                    <p>{formData.idStatus === "Individual ID" ? "MI_123456" : "MUI_123456"}</p>
                    <p>3/05/1996</p>
                  </div>
                </div>
              </Col>
              <Col md={6}>
                <div className="contact-info">
                  ...
                  {formData.idStatus === "Individual ID" &&<p><strong>Master ID: MXXXXXX589</strong></p>}
                  <p>
                    <span>
                      <svg
                  ...
                  <button type="button" className="submit-btn d-flex align-items-center mt-4 justify-content-center btn btn-primary ml-auto" style={{minWidth: 180}} onClick={() => setShowIdDetails(true)}>Add as Staff</button>
                </div>
              </Col>
            </Row>
          )}
          ...
          {formData.idStatus !== "" && (
            <Row>
              ...
              <Col md={2} className="d-flex align-items-center justify-content-center">
                <button type="button" className="submit-btn d-flex m-0 w-100 align-items-center mt-4 mt-md-2 justify-content-center btn btn-primary" onClick={() => setShowIdDetails(true)}>Check</button>
              </Col>
            </Row>
          )}
          ...
          {/* <Row>
            <Col md={6}>
              <Form.Group controlId="signature">
                <Form.Label>Enter Your Signature Key</Form.Label>
                <Form.Control
                  type="text"
                  name="signature"
                  value={formData.signature}
